...
export function ChatWindow(props: {
  ...
  const { messages, input, setInput, handleInputChange, handleSubmit, isLoading: chatEndpointIsLoading, setMessages,reload,append } = 
  useChat({
      api: endpoint,
  ...
  return (
    ...
    <div
      className="flex flex-col-reverse w-full mb-4 overflow-auto scrollbar-hide flex-grow ease-in-out"
